export default function handler(req, res) {
  const agents = [
    ...
    // These launch into the WP suite UI; no local dashboard or Stripe sub.
    {
      ...
      description: 'Paste any WordPress URL for a fast security check with plugin versions, known CVEs, risk scores, and a client-ready report. Includes a free starter allowance.',
      category: 'WordPress',
      price: 19,
      priceLabel: 'Free + from $19/mo per site',
      freemium: true,
      external: true,
      url: 'https://wp.devcabin.tech/agents/vulnerability-scanner',
      features: ['Free: 1 scan per month', 'Known CVE matching', 'Plugin version detection', 'Risk-scored report', 'Client-ready PDF'],
    ...
    },
    {
      ...
      description: 'Describe the business and get a hand-picked plugin stack with compatibility checks, licensing costs, and setup steps. Includes a free usage tier.',
      category: 'WordPress',
      price: 29,
      ...
      features: ['Free: 2 recommendations per month', 'Business-type analysis', 'Compatibility checks', 'Licensing cost rollup', 'Install order'],
    ...
    },
    {
      ...
      description: 'Diagnose and improve Core Web Vitals for WordPress sites with a prioritised fix list for images, caching, render-blocking, and database cleanup.',
      category: 'WordPress',
      price: 39,
      priceLabel: 'Free + from $39/report',
      freemium: true,
      external: true,
      url: 'https://wp.devcabin.tech/agents/speed-optimizer',
      features: ['Free: homepage snapshot', 'Core Web Vitals diagnosis', 'Prioritised fix list', 'Image / cache / DB analysis', 'Client-ready report'],
    ...
    },
    {
      ...
      description: 'Auto-generate branded white-label client reports for uptime, updates, backups, and security scans. Built for recurring care-plan delivery.',
      category: 'WordPress',
      price: 29,
      priceLabel: 'Free + from $29/mo',
      freemium: true,
      external: true,
      url: 'https://wp.devcabin.tech/agents/maintenance-report',
      features: ['Free: 1 branded sample report', 'White-label branding', 'Uptime + update stats', 'Backup + scan summary', 'PDF + HTML export'],
    ...
    },
    {
      ...
      description: 'Describe a design change and get exact CSS or PHP snippets with conflict warnings for Divi, Elementor, and Astra, including child-theme scaffold support.',
      category: 'WordPress',
      price: 19,
      priceLabel: 'Free + from $19/mo',
      freemium: true,
      external: true,
      url: 'https://wp.devcabin.tech/agents/child-theme-builder',
      features: ['Free: 3 snippets per month', 'CSS + PHP snippets', 'Divi / Elementor / Astra conflict checks', 'Full child-theme scaffold', 'Copy-paste ready'],
      tools: ['OpenAI', 'wp.devcabin.tech suite'],
    ...
    },
    {
      ...
      description: 'Crawl any sitemap or URL list, check live HTTP status for every link, and export broken-link and redirect maps as CSV for quick fixes.',
      category: 'WordPress',
      price: 19,
      priceLabel: 'Free + from $19/mo',
      freemium: true,
      ...
      features: ['Free: up to 100 URLs per scan', 'Sitemap crawler', 'Live HTTP status', 'CSV export', 'WP Redirection import file'],
      tools: ['OpenAI', 'wp.devcabin.tech suite'],
